...
puts "There're #{second_per_minute} in a minute"
puts "There're #{minute_per_hour} in an hour"
puts "There're #{hour_per_day} in a day"
puts "There're #{day_per_week} in a week"
